  ...
  return (
    <div className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-brand-cream px-4">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute -left-20 -top-20 h-80 w-80 rounded-full bg-brand-primary blur-3xl" />
        <div className="absolute -bottom-20 -right-20 h-80 w-80 rounded-full bg-brand-primary blur-3xl" />
      </div>
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="relative">
          <h1 className="font-serif text-[150px] font-light leading-none text-brand-primary/20 md:text-[200px]">
            404
          </h1>
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="font-serif text-5xl text-brand-primary md:text-6xl">404</span>
          </div>
        </div>

        {/* 文字说明 */}
        <h2 className="mt-6 font-serif text-2xl text-brand-charcoal md:text-3xl">页面未找到</h2>
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/"
            className="flex items-center gap-2 rounded-full bg-brand-primary px-6 py-3 text-sm font-medium text-white shadow-md transition-all hover:bg-brand-primary/90 hover:shadow-lg"
          >
        ...
        <div className="text-sm text-brand-charcoal/50">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/guide" className="text-brand-primary hover:underline">
              官方指南
            </Link>
