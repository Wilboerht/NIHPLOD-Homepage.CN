...
import { MapPin, Briefcase, X, Upload, FileText, Send, Loader2, Home } from "lucide-react";
  ...
  return (
    <>
      <div className="scrollbar-hide flex h-screen flex-col overflow-y-auto bg-[#fefcf8]">
        {/* Top Bar */}
        <nav className="fixed left-0 right-0 top-0 z-50 flex w-full items-center justify-between bg-[#fefcf8]/80 px-6 py-3 backdrop-blur-md md:px-20 md:py-6">
          <Link href="/">
