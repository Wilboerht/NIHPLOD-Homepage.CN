...
export function ServicesContent({ content }: ServicesContentProps) {
  ...
  return (
    <>
      ...
      >
        <div className="flex h-full flex-col items-center pointer-events-none drop-shadow-[4px_2px_1px_rgba(0,38,62,0.2)] max-lg:drop-shadow-none">
          {/* 主内容卡片容器 */}
          <div className="w-full flex-1 overflow-hidden rounded-none lg:rounded-3xl bg-[#FFFFFF] lg:bg-[#FAF5EA] pointer-events-auto relative">
            ...
            <div className="flex h-full flex-col p-4 sm:p-6 lg:p-8">
              ...
              <div className="lg:hidden relative flex-shrink-0 h-[88px] w-full flex items-center justify-center pointer-events-auto">
                {/* 返回按钮 */}
                <Link href="/" className="absolute left-0 top-0 bottom-0 flex items-center justify-center px-4 py-[10px]">
              ...
              <div className="mt-auto pt-4 pb-4 sm:pt-6 lg:pt-8 border-t border-brand-charcoal/5 mx-6 lg:mx-12 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 max-lg:border-0">
                <p className="text-[10px] sm:text-[12px] font-medium tracking-[0.12em] text-[#4A6272]/30 uppercase max-lg:font-medium">
