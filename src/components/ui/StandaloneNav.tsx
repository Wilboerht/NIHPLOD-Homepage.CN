            ...
            >
              <div className="flex items-center justify-between mb-8">
                ...
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full hover:bg-brand-charcoal/5"
                  aria-label="关闭菜单"
                >
                  <X className="h-5 w-5 text-[#00263E]" />
                </button>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="my-2 h-px bg-brand-charcoal/8" />
                <Link
                  href="/"
                  onClick={() => setMobileOpen(false)}
                  className="rounded-xl px-4 py-3.5 text-[15px] font-light tracking-[0.08em] text-[#00263E] transition-colors hover:bg-brand-charcoal/5"
