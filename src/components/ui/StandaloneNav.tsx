      ...
      >
        <div className="relative flex w-full items-center justify-center md:justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {title && (
              <>
                <div className="h-5 w-px bg-brand-charcoal/20 md:h-6" />
                <span className="text-[13px] font-light tracking-[0.15em] text-brand-charcoal/60 md:text-[15px]">
                  {title}
                </span>
              </>
            )}
          ...
          <div className="hidden items-center gap-1 md:flex">
            ...
            <Link
              href="/"
              className="group relative inline-flex items-center gap-1.5 px-3 py-2 text-[15px] font-light tracking-[0.15em] text-brand-charcoal transition-colors duration-500 hover:text-brand-charcoal-light"
            >
          ...
          {leftButton && (
            ...
            >
              <BookOpen className="h-5 w-5 text-brand-charcoal" strokeWidth={1.5} />
            </button>
          )}
