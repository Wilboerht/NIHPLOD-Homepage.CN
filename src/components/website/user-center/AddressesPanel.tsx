    ...
    <div className="h-full flex flex-col pt-4 md:pt-10">
      ...
      <div className="flex-1 overflow-y-auto px-16 py-0 scrollbar-hide flex flex-col">
        ...
        {loading ? (
          ...
          >
            <div className="w-16 h-16 rounded-full bg-[#FAF5EA]/60 backdrop-blur-sm border border-stone-200/60 flex items-center justify-center mb-5">
    ...
    <div className="flex-1">
      ...
      <div className="relative">
        <button
          ...
          className={`w-full px-4 py-3 bg-[#FAF5EA]/40 backdrop-blur-sm border rounded-xl text-left flex items-center justify-between transition-all text-base ${disabled
          ...
          {open && !disabled && (
            <>
              ...
              <m.div
                ...
                className="absolute z-50 top-full left-0 right-0 mt-2 bg-[#FAF5EA]/95 backdrop-blur-xl border border-stone-200/60 rounded-xl shadow-lg max-h-60 overflow-y-auto overflow-x-hidden p-1.5 scrollbar-hide"
              >
                {options.length === 0 ? (
                    ...
                    {options.map((opt) => (
                      <button
                        ...
                        className={`w-full px-4 py-2.5 text-left text-[14px] rounded-lg transition-all flex items-center justify-between group ${opt.label === value
                          ? "bg-[#FAF5EA]/40 text-stone-800 font-medium"
        ...
        <div className="space-y-6 max-w-2xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-[#FAF5EA]/40 backdrop-blur-sm border border-stone-200/60 rounded-xl text-stone-800 font-medium placeholder:text-stone-300 outline-none focus:border-stone-400 focus:ring-4 focus:ring-stone-100 transition-all transition-colors"
                placeholder="请输入姓名"
                required
              />
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-[#FAF5EA]/40 backdrop-blur-sm border border-stone-200/60 rounded-xl text-stone-800 font-medium placeholder:text-stone-300 outline-none focus:border-stone-400 focus:ring-4 focus:ring-stone-100 transition-all transition-colors resize-none"
              rows={3}
