              ...
              {loading ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className={`w-full py-3.5 text-white rounded-xl font-medium disabled:opacity-50 flex items-center justify-center gap-2 ${payMethod === "wechat" ? "bg-green-500 hover:bg-green-600" : "bg-blue-500 hover:bg-blue-600"}`}
                  >
