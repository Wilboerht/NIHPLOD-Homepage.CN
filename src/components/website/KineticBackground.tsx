  ...
  return (
    <div ref={wrapperRef} className="kinetic-background-wrapper">
      ...
      <div className="kinetic-watermark">
        {/* PC 端水印 */}
        <div className="relative hidden opacity-[0.7] md:block">
          <Image
        ...
        {/* 移动端水印 - 竖版 SVG */}
        <div className="absolute inset-0 block opacity-[0.7] md:hidden">
          <Image
      ...
      <div ref={containerRef} className="kinetic-container">
        ...
        >
          <div
            ...
            style={{ marginBottom: "12px", lineHeight: "1.3", fontSize: "1.8rem", fontWeight: 400 }}
          >
            更少步骤
            <br />
            更多呵护
        ...
        >
          <div className="kinetic-name" style={{ fontSize: "1.8rem", fontWeight: 400 }}>
            逆转时光
          </div>
          <div
            className="kinetic-desc"
