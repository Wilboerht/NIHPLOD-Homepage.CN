  ...
  return (
    <div className="pointer-events-auto relative flex flex-col items-center md:hidden">
      ...
      <m.button
        ...
        whileTap={{ scale: 0.95 }}
        className="pointer-events-auto relative z-[30] flex min-h-0 min-w-0 cursor-pointer items-center text-[13px] font-medium tracking-[0.12em] text-brand-primary/70 transition-all hover:text-brand-primary"
      >
        <span>更多</span>
      </m.button>
    </div>
