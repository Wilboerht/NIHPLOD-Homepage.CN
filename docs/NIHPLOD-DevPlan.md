...
| # | 任务 | 优先级 | AI 辅助度 |
|---|------|--------|-----------|
| 5.3.1 | CSP 安全头配置 (next.config.js) | P0 | ⭐⭐⭐ |
| 5.3.2 | ISR 页面缓存配置 | P1 | ⭐⭐⭐ |
| 5.3.3 | 图片优化流程 (sharp WebP) | P1 | ⭐⭐⭐ |
| 5.3.4 | 微信分享 SDK 集成 (可选) | P2 | ⭐⭐ |
...
|---|------|--------|-----------|
| 5.4.1 | 功能测试 | P0 | ⭐ |
| 5.4.2 | Core Web Vitals 性能测试 | P1 | ⭐⭐ |
| 5.4.3 | PM2 配置 | P0 | ⭐⭐⭐ |
| 5.4.4 | Nginx 配置 (缓存 + 安全头) | P0 | ⭐⭐⭐ |
| 5.4.5 | SSL 证书配置 | P0 | ⭐⭐⭐ |
| 5.4.6 | 域名解析与上线 | P0 | ⭐ |
| 5.4.7 | Umami 统计部署 | P1 | ⭐⭐⭐ |
| 5.4.8 | 数据库备份脚本配置 | P0 | ⭐⭐⭐ |
| 5.4.9 | 错误监控配置 (Sentry 可选) | P2 | ⭐⭐⭐ |
