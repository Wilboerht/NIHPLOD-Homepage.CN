...
function RequireAuth({
  ...
  const loginTriggeredRef = useRef2(false);
  ...
  if (isLoading) {
    return fallback || React2.createElement("div", null, "\u6B63\u5728\u9A8C\u8BC1\u767B\u5F55\u72B6\u6001...");
  }
  if (!isAuthenticated) {
    if (loginError) {
      if (renderLoginError) {
      ...
      return React2.createElement(
        "div",
        null,
        React2.createElement("p", null, `\u767B\u5F55\u672A\u5B8C\u6210\uFF1A${message}`),
        React2.createElement("button", { onClick: retry }, "\u91CD\u8BD5\u767B\u5F55")
      );
    }
    if (fallback) return React2.createElement(React2.Fragment, null, fallback);
    return React2.createElement("div", null, "\u8BF7\u5148\u767B\u5F55");
  }
...
function CallbackPage({ onSuccess, onError, renderError } = {}) {
  ...
  if (processing) {
    return React3.createElement(
      ...
      React3.createElement("p", null, "\u6B63\u5728\u5904\u7406\u767B\u5F55\u56DE\u8C03...")
    );
  }
  return null;
}
